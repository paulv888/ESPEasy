...
//**************************************************************************/
// Configures to INA219 to be able to measure My Solar, shunt =
// Sample = 32
//**************************************************************************/
void Plugin_027_setCalibration_16V_400mA(uint8_t i2caddr) {
  const uint8_t idx = Plugin_027_device_index(i2caddr);

//  _ina219_data[idx].calValue = 6143;
  _ina219_data[idx].calValue = 5393; // Calibrated

  // Set multipliers to convert raw current/power values
  _ina219_data[idx].currentDivider_mA = 4;  // Current LSB = 250A per bit (1000/250 = 4)
